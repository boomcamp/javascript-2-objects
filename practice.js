...
var me = {name:"Hamlet De Los Reyes" , age: 21};
alert(me.name);
...
favoriteThings.car = "trueno ae86";
...
function makePerson(name_x, birthday_x, ssn_x) {
  var cont = {
    name: name_x,
    birthday: birthday_x,
    ssn: ssn_x
...
function makeCard(cardNumber_x, expirationDate_x, securityCode_x){
  var creditcard = {
    cardNumber: cardNumber_x,
    expirationDate: expirationDate_x,
    securityCode: securityCode_x
  };
  return creditcard;
}
